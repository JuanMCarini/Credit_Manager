...
CREATE TABLE provinces (ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT, Name VARCHAR(100) UNIQUE, Country_ID INT, FOREIGN KEY (Country_ID) REFERENCES countries(ID));

CREATE TABLE cities (ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT, Name VARCHAR(100) UNIQUE, Province_ID INT NOT NULL, FOREIGN KEY (Province_ID) REFERENCES provinces(ID));
